...
# import dask as dd
from dask.typing import Mapping, Any #Graph  # , Key, NoDefault, no_default

# old dask version has definition of Graph no yet implemented
...
def quick_pie_value_count(
    ...
    fig.update_layout(
        title_text=title + " (Total: " + str(df_counts.values.sum()) + ")",
        height=500,
        width=600,
    )
